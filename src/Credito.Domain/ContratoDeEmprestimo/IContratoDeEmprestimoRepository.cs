...
namespace Credito.Domain.ContratoDeEmprestimo
{
    ...
    {
        Task<IList<ContratoDeEmprestimoAggregate>> FindAsync(Expression<Func<ContratoDeEmprestimoAggregate, bool>> filter,
                                                             int skip = 0,
                                                             int take = 10,
                                                             CancellationToken cancellationToken = default);
        Task<IList<ContratoDeEmprestimoAggregate>> GetAsync(int skip = 0,
                                                            int take = 10,
                                                            CancellationToken cancellationToken = default);
